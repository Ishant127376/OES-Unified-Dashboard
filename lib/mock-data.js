 ...
 * @typedef {"online" | "offline" | "warning"} DeviceStatus
...
export const initialDevices = [
  {
    serialNumber: serial10("1029384756"),
    name: "Smart Meter A1",
    type: "Smart Meter",
  ...
  {
    serialNumber: serial10("5647382910"),
    name: "Gateway G1",
    type: "Gateway",
    location: "Plant 1 · Control Room",
    macAddress: "B8:27:EB:9A:BC:DE",
    firmwareVersion: "v2.0.3",
    protocol: "MQTT",
    status: "online",
  },
  {
    serialNumber: serial10("0192837465"),
    name: "HVAC Unit H1",
    type: "HVAC",
    location: "Plant 2 · Utility Floor",
    macAddress: "DC:A6:32:65:43:21",
    firmwareVersion: "v1.0.7",
    protocol: "DNP3",
    status: "warning",
  },
  {
    serialNumber: serial10("9081726354"),
    name: "Smart Meter B2",
    type: "Smart Meter",
